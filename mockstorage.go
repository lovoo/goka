...
func (m *MockStorage) GetP(arg0 string) ([]byte, io.Closer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetP", arg0)
	ret0, _ := ret[0].([]byte)
...
func (mr *MockStorageMockRecorder) GetP(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetP", reflect.TypeOf((*MockStorage)(nil).GetP), arg0)
}
