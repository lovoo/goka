...
func templatesMonitorProcessorGoHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/monitor/processor.go.html", size: 6543, mode: os.FileMode(436), modTime: time.Unix(1500888201, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
