...
// webTemplatesGraphIndexGoHtml reads file data from disk. It returns an error on failure.
func webTemplatesGraphIndexGoHtml() (*asset, error) {
	path := "/home/franz/work/gocode/src/github.com/lovoo/goka/web/templates/graph/index.go.html"
	name := "web/templates/graph/index.go.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
